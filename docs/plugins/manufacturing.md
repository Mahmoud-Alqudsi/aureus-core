...
7. **Disassembly & Unbuild Orders (`UnbuildOrder`)**:
   - Manages the dismantling and reverse manufacturing of finished goods back into their constituent components, returning raw materials to inventory and adjusting stock valuation.
...
- **Product Costing**: Computes exact unit component costs and routing operation labor/overhead costs, feeding inventory valuation.
