...
- **`sales_orders`**: Primary order header table storing state, amounts, currency, customer references, locking status, delivery status, and invoice status.
